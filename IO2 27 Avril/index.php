...
<header>
    ...
    <div class="droite"><a href="../IO2/index.php" ><img src="../IO2/image/Nakama San2.png" width=40% height=40%></a></div>
...
if(!estConnecte()){?>
    <div class="formulaire">
      <a href="../IO2/page de connexion/PageInscription.php"><input type="button" value="S'inscrire"></a>
      <a href="../IO2/page de connexion/connexion1.php"><input type="button" value="Se connecter"></a>
     </div>
<?php } else {?>
    <div class="formulaire">
      <a href="../IO2/php/pageProfile.php"><input type="button" value=<?php echo $_SESSION['auth']['pseudo'] ?> ></a>
      <a href="../IO2/php/deconnexion.php"><input type="button" value="Se déconnecter"></a>
    </div>
<?php } ?>
  </header>
